...
Revision changes:
- Fixed a bug in the GPS baud rate changing logic that was introducede by the last checkin. Added checks for Screen OFF mode to allow working with no display from the start. 
